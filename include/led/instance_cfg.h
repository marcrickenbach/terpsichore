/** ****************************************************************************
 * @brief LED instance configuration interface.
 */

#ifndef FKMG_LED_INSTANCE_CFG_H
#define FKMG_LED_INSTANCE_CFG_H
...
struct LED_Instance_Cfg{
    ...
    /* Required: for queuing state machine events (LED_SM_Evt). */
    struct{
     ...
     * callback is sent event with signal k_LED_Sig_Instance_Initialized. NULL
     * skips callback. */
    LED_Listener_Cb cb;
};
