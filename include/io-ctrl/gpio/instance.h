/** ****************************************************************************
 * @brief FKMG GPIO Control instance interface.
 *
...
#ifndef FKMG_IO_CTRL_GPIO_INSTANCE_H
#define FKMG_IO_CTRL_GPIO_INSTANCE_H
...
struct FKMG_IO_CTRL_GPIO_Instance{
    #if CONFIG_FKMG_FKMG_IO_CTRL_GPIO_RUNTIME_ERROR_CHECKING
    /* Error status. */
	enum FKMG_IO_CTRL_GPIO_Err_Id err;
    #endif
    ...
    /* Current sm event. */
    struct FKMG_IO_CTRL_GPIO_SM_Evt sm_evt;

    /* Singly linked lists to keep track of things. */
    struct{
        sys_slist_t listeners[k_FKMG_IO_CTRL_GPIO_Evt_Sig_Cnt];
    }list;
...
#endif /* FKMG_IO_CTRL_GPIO_INSTANCE_H */
