/** ****************************************************************************
 * @brief FKMG GPIO Control instance configuration interface.
 */

#ifndef FKMG_IO_CTRL_GPIO_INSTANCE_CFG_H
#define FKMG_IO_CTRL_GPIO_INSTANCE_CFG_H
...
struct FKMG_IO_CTRL_GPIO_Instance_Cfg{
    ...
    /* Required: for queuing state machine events (FKMG_IO_CTRL_GPIO_SM_Evt). */
    struct{
     ...
     * callback is sent event with signal k_FKMG_IO_CTRL_GPIO_Sig_Instance_Initialized. NULL
     * skips callback. */
...
#endif /* FKMG_IO_CTRL_GPIO_INSTANCE_CFG_H */
