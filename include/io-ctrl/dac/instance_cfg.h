/** ****************************************************************************
 * @brief FKMG DAC Control instance configuration interface.
 */

#ifndef FKMG_IO_CTRL_DAC_INSTANCE_CFG_H
#define FKMG_IO_CTRL_DAC_INSTANCE_CFG_H
...
struct FKMG_IO_CTRL_DAC_Instance_Cfg{
    ...
    /* Required: for queuing state machine events (FKMG_IO_CTRL_DAC_SM_Evt). */
    struct{
     ...
     * callback is sent event with signal k_FKMG_IO_CTRL_DAC_Sig_Instance_Initialized. NULL
     * skips callback. */
    FKMG_IO_CTRL_DAC_Listener_Cb cb;

    uint32_t dac_t_duration_ms;
    uint32_t dac_t_period_ms;
};
...
#endif /* FKMG_IO_CTRL_DAC_INSTANCE_CFG_H */
