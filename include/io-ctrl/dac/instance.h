/** ****************************************************************************
 * @brief FKMG DAC Control instance interface.
 *
...
#ifndef FKMG_IO_CTRL_DAC_INSTANCE_H
#define FKMG_IO_CTRL_DAC_INSTANCE_H
...
struct FKMG_IO_CTRL_DAC_Instance{
    #if CONFIG_FKMG_FKMG_IO_CTRL_DAC_RUNTIME_ERROR_CHECKING
    /* Error status. */
	enum FKMG_IO_CTRL_DAC_Err_Id err;
    #endif
    ...
    /* Current sm event. */
    struct FKMG_IO_CTRL_DAC_SM_Evt sm_evt;

    /* Singly linked lists to keep track of things. */
    struct{
        sys_slist_t listeners[k_FKMG_IO_CTRL_DAC_Evt_Sig_Cnt];
    }list;
...
#endif /* FKMG_IO_CTRL_DAC_INSTANCE_H */
