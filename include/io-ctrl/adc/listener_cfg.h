/** ****************************************************************************
 * @brief FKMG ADC Control listener configuration interface.
 */

#ifndef FKMG_IO_CTRL_ADC_LISTENER_CB_CFG_H
#define FKMG_IO_CTRL_ADC_LISTENER_CB_CFG_H
...
struct FKMG_IO_CTRL_ADC_Listener;

struct FKMG_IO_CTRL_ADC_Listener_Cfg{
    ...
    enum FKMG_IO_CTRL_ADC_Evt_Sig sig;
...
#endif /* FKMG_IO_CTRL_ADC_LISTENER_CB_CFG_H */
