/** ****************************************************************************
 * @brief FKMG ADC Control listener instance interface.
 */

#ifndef FKMG_IO_CTRL_ADC_LISTENER_H
#define FKMG_IO_CTRL_ADC_LISTENER_H
...
#endif /* FKMG_IO_CTRL_ADC_LISTENER_H */
