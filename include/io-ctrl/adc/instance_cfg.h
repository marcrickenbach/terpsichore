/** ****************************************************************************
 * @brief FKMG ADC Control instance configuration interface.
 */

#ifndef FKMG_IO_CTRL_ADC_INSTANCE_CFG_H
#define FKMG_IO_CTRL_ADC_INSTANCE_CFG_H
...
struct FKMG_IO_CTRL_ADC_Instance_Cfg{
    ...
    /* Required: for queuing state machine events. */
    struct{
     ...
     * callback is sent event with signal k_XXX_Sig_Instance_Initialized. NULL
     * skips callback. */
...
#endif /* FKMG_IO_CTRL_ADC_INSTANCE_CFG_H */
